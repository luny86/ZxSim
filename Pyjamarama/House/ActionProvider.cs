...
namespace Pyjamarama.House
{
    ...
    internal class ActionProvider : IActionProvider, IBuildable
    {
        ...
        private void Initialise()
        {
            ...
            RegisterTest(new TestDummy(0)); //new TestBoxingGlove());
        ...
        {
            // Item 1
            new List<byte>  { 0x01, 0x3a, 0x88, 0xfd, 0x01, 0xfe, 0x00, 0x08, 0xa0, 0xfd, 0x02, 0x11, 0xe8, 0x98, 0xfe, 0xff },
            // Item 2
            new List<byte> { 0x01, 0x48, 0x98, 0xfd, 0x01, 0xfe, 0x00, 0xc8, 0x88, 0xfd, 0x02, 0x02, 0x08, 0x98, 0xfe, 0x00, 0x00, 0x48, 0xfd, 0x02, 0x05, 0xd8, 0x98, 0xfe, 0x00, 0xe8, 0x88, 0x08, 0xfd, 0x02, 0x03, 0x2e, 0x98, 0xfe, 0xff },
            // Item 3
            new List<byte> { 0x01, 0x98, 0x98, 0x02, 0x0b, 0xfd, 0x01, 0xfe, 0x00, 0x08, 0x88, 0xfd, 0x02, 0x01, 0xc8, 0x98, 0xfe, 0x00, 0xe8, 0x88, 0xfd, 0x02, 0x04, 0x08, 0x98, 0xfe, 0x00, 0x38, 0x88, 0xfd, 0x02, 0x03, 0xe8, 0x98, 0xfe, 0xff },
            // Item 4
