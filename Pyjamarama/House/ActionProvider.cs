...
namespace Pyjamarama.House
{
    ...
    internal class ActionProvider : IActionProvider, IBuildable
    {
        ...
        static List<List<byte>> _actions = new List<List<byte>>()
        {
            ...
            // Item 2
            new List<byte> { 
                TestSlotPosition, 0x48, 0x98, 0xfd, 0x01, 0xfe, 
                TestPosition, 0xc8, 0x88, 0xfd, 0x02, 0x02, 0x08, 0x98, 0xfe, 
                TestPosition, 0x00, 0x48, 0xfd, 0x02, 0x05, 0xd8, 0x98, 0xfe, 
                TestPosition, 0xe8, 0x88, TestBoxingGlove, 0xfd, 0x02, 0x03, 0x2e, 0x98, 0xfe, 
                0xff },
            // Item 3
